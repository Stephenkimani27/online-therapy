...
<section class="about-section">
    ...
    <div class="about-left">
        <img src="image/mary.jpg" width="500px" />
    </div>
    ...
    <div class="about-right">
        ...
        <h1>About Me</h1>
        <p>
          Mary linda is a graduate from the University of Illinois at Chicago,
            where she received her Master’s from the Jane Addams College of Social Work.
            Her education at UIC focused on Children and Family Services.
        </p>
        <div class="address">
            <ul>
                <li>
            ...
            <div class="w3jar-accordion">
                <ul class="panel">
                    ...
                    <li class="wrap"><a href="#" class="title">Treatment model</a>
                        <ul class="sub-panel">
                            <li>1.Solution-Focused Therapy</li>
...
<script>
    var url = 'https://wati-integration-service.clare.ai/ShopifyWidget/shopifyWidget.js?62040';
