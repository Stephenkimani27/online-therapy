...
<section class="about-section">
    ...
    <div class="about-left">
        <img src="image/peter.jpg" width="500px" />
    </div>
    ...
    <div class="about-right">
        ...
        <h1>About Me</h1>
        <p>
         peter musando   received her Master’s Degree in Marriage and Family Therapy from Adler University in 2010.
        </p>
        <div class="address">
            <ul>
                <li>
...
<script>
    var url = 'https://wati-integration-service.clare.ai/ShopifyWidget/shopifyWidget.js?55277';
