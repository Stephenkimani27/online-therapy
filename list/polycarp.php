...
<section class="about-section">
    ...
    <div class="about-left">
        <img src="image/polcarp.jpg" width="500px" />
    </div>

    <!-- about right  -->
    <div class="about-right">
        <h4>polycarp ochieng</h4>
        <h1>About Me</h1>
        <p>
            polycarp ochieng   received her Master’s Degree in Counseling from National Louis University in 2012. She has experience working in private practice and school counseling
        </p>
        <div class="address">
            <ul>
                <li>
...
<script>
    var url = 'https://wati-integration-service.clare.ai/ShopifyWidget/shopifyWidget.js?71521';
