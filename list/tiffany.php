...
<section class="about-section">
    ...
    <div class="about-left">
        <img src="image/tiffany.jpg" width="500px" />
    </div>

    <!-- about right  -->
    <div class="about-right">
        <h4>tiffany kisero</h4>
        <h1>About Me</h1>
        <p>
            tiffany kisero   received her Master’s Degree in Counseling from National Louis University in 2012. She has experience working in private practice and school counseling
        </p>
        <div class="address">
            <ul>
                <li>
