                    ...
                    <tr>
                        <td >
                            ...
                            <p>Haven't any idea about doctors? no problem let's jumping to 
                                ...
                                <a href="schedule.php" class="non-style-link"><b></b> </a><br>
                            ...
                            <form action="schedule.php" method="post" style="display: flex">
                                ...
                                <input type="search" name="search" class="input-text " placeholder="Search Therapist and We will Find The Session Available" list="doctors" style="width:45%;">&nbsp;&nbsp;
